...
import '../helper/defect_info.dart';
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    const Spacer(),
                    // Show classification result with defect pricing
                    SingleChildScrollView(
                      child: Column(
                        children: [
                          if (classification != null) ...[
                            // Length x Width input fields
                            Padding(
                            ...
                            Builder(builder: (context) {
                              ...
                              final length =
                                  double.tryParse(_lengthController.text) ??
                                      1.0;
                              final width =
                                  double.tryParse(_widthController.text) ?? 1.0;
                              final areaM2 = length * width;
                              final result = DefectPricing.calculate(
                                  topEntry.key, areaM2);
                              ...
                              return Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      'Detected: ${topEntry.key.replaceAll('_', ' ').toUpperCase()}',
                                    ...
                                    Text(
                                      'Area: ${areaM2.toStringAsFixed(2)} m²  (${length.toStringAsFixed(1)}m × ${width.toStringAsFixed(1)}m)',
                                      style: TextStyle(
                                          color: Colors.grey.shade600),
                                    ),
                                    const Divider(),
                                    ...
                                    const SizedBox(height: 8),
                                    Text(
                                        'Repair Method: ${result.repairMethod}'),
